...
import me.salamander.mallet.compiler.analysis.definition.DefinitionSemilattice;
import me.salamander.mallet.compiler.analysis.definition.DefinitionValue;
...
public class CompiledMethod {
    ...
    private void writeSignature(StringBuilder sb, GlobalCompilationContext ctx) {
        //Return type
    ...
    public void declare(StringBuilder sb, GlobalCompilationContext ctx) {
        this.writeSignature(sb, ctx);
        sb.append(";\n");
    }

    public void define(StringBuilder glsl, GlobalCompilationContext ctx, ShaderCompiler shaderCompiler) {
    ...
    private ASTVisitor makePrinter(StringBuilder sb, GlobalCompilationContext ctx, ShaderCompiler shaderCompiler) {
