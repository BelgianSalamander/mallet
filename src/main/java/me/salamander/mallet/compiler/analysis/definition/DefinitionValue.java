package me.salamander.mallet.compiler.analysis.definition;
...
public class DefinitionValue extends Value {
    public static final Instruction ARG_PLACEHOLDER = new Instruction() {
        ...
        @Override
        public Instruction visitAndReplace(Function<me.salamander.mallet.compiler.instruction.value.Value, me.salamander.mallet.compiler.instruction.value.Value> valueCopier, Function<Location, Location> locationCopier) {
            throw new UnsupportedOperationException();
        }
