...
public class BinaryOperation implements Value {
    ...
    public interface Op{
        ...
        Op CMP = new Op() {
            ...
            @Override
            public void writeGLSL(StringBuilder sb, Value left, Value right, MalletContext ctx, ShaderCompiler shaderCompiler) {
                sb.append("cmp(");
        ...
        void writeGLSL(StringBuilder sb, Value left, Value right, MalletContext ctx, ShaderCompiler shaderCompiler);
    }
